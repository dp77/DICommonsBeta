...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.di.contacts") && !packageName.startsWith("com.di.dialer")) {
        true
    } else if ((packageName.startsWith("com.di.contacts") || packageName.startsWith("com.di.dialer")) && isQPlus()) {
