...
import com.dilib.commons.helpers.*
import com.dilib.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.dilib.commons.models.AlarmSound
import com.dilib.commons.models.BlockedNumber
import com.dilib.commons.models.contacts.ContactRelation
import com.dilib.strings.R as stringsR
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.dilib.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isOrWasThankYouInstalled(): Boolean {
    return when {
        ...
        isPackageInstalled("com.dilib.audiobook") -> true
        isPackageInstalled("com.dilib.voicerecorder") -> true
        isPackageInstalled("com.dilib.files") -> true
        else -> false
    }
}
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.dilib."))
...
fun Context.getRelationTypeText(type: Int, label: String): String {
    return if (type == BaseTypes.TYPE_CUSTOM) {
        ...
        getString(
            when (type) {
                // Relation.TYPE_CUSTOM   -> com.dilib.strings.R.string.custom
                Relation.TYPE_ASSISTANT -> com.dilib.strings.R.string.relation_assistant_g
                Relation.TYPE_BROTHER -> com.dilib.strings.R.string.relation_brother_g
                Relation.TYPE_CHILD -> com.dilib.strings.R.string.relation_child_g
                Relation.TYPE_DOMESTIC_PARTNER -> com.dilib.strings.R.string.relation_domestic_partner_g
                Relation.TYPE_FATHER -> com.dilib.strings.R.string.relation_father_g
                Relation.TYPE_FRIEND -> com.dilib.strings.R.string.relation_friend_g
                Relation.TYPE_MANAGER -> com.dilib.strings.R.string.relation_manager_g
                Relation.TYPE_MOTHER -> com.dilib.strings.R.string.relation_mother_g
                Relation.TYPE_PARENT -> com.dilib.strings.R.string.relation_parent_g
                Relation.TYPE_PARTNER -> com.dilib.strings.R.string.relation_partner_g
                Relation.TYPE_REFERRED_BY -> com.dilib.strings.R.string.relation_referred_by_g
                Relation.TYPE_RELATIVE -> com.dilib.strings.R.string.relation_relative_g
                Relation.TYPE_SISTER -> com.dilib.strings.R.string.relation_sister_g
                Relation.TYPE_SPOUSE -> com.dilib.strings.R.string.relation_spouse_g

                // Relation types defined in vCard 4.0
                ContactRelation.TYPE_CONTACT -> com.dilib.strings.R.string.relation_contact_g
                ContactRelation.TYPE_ACQUAINTANCE -> com.dilib.strings.R.string.relation_acquaintance_g
                // ContactRelation.TYPE_FRIEND -> com.dilib.strings.R.string.relation_friend
                ContactRelation.TYPE_MET -> com.dilib.strings.R.string.relation_met_g
                ContactRelation.TYPE_CO_WORKER -> com.dilib.strings.R.string.relation_co_worker_g
                ContactRelation.TYPE_COLLEAGUE -> com.dilib.strings.R.string.relation_colleague_g
                ContactRelation.TYPE_CO_RESIDENT -> com.dilib.strings.R.string.relation_co_resident_g
                ContactRelation.TYPE_NEIGHBOR -> com.dilib.strings.R.string.relation_neighbor_g
                // ContactRelation.TYPE_CHILD -> com.dilib.strings.R.string.relation_child
                // ContactRelation.TYPE_PARENT -> com.dilib.strings.R.string.relation_parent
                ContactRelation.TYPE_SIBLING -> com.dilib.strings.R.string.relation_sibling_g
                // ContactRelation.TYPE_SPOUSE -> com.dilib.strings.R.string.relation_spouse
                ContactRelation.TYPE_KIN -> com.dilib.strings.R.string.relation_kin_g
                ContactRelation.TYPE_MUSE -> com.dilib.strings.R.string.relation_muse_g
                ContactRelation.TYPE_CRUSH -> com.dilib.strings.R.string.relation_crush_g
                ContactRelation.TYPE_DATE -> com.dilib.strings.R.string.relation_date_g
                ContactRelation.TYPE_SWEETHEART -> com.dilib.strings.R.string.relation_sweetheart_g
                ContactRelation.TYPE_ME -> com.dilib.strings.R.string.relation_me_g
                ContactRelation.TYPE_AGENT -> com.dilib.strings.R.string.relation_agent_g
                ContactRelation.TYPE_EMERGENCY -> com.dilib.strings.R.string.relation_emergency_g

                ContactRelation.TYPE_SUPERIOR -> com.dilib.strings.R.string.relation_superior_g
                ContactRelation.TYPE_SUBORDINATE -> com.dilib.strings.R.string.relation_subordinate_g
                ContactRelation.TYPE_HUSBAND -> com.dilib.strings.R.string.relation_husband_g
                ContactRelation.TYPE_WIFE -> com.dilib.strings.R.string.relation_wife_g
                ContactRelation.TYPE_SON -> com.dilib.strings.R.string.relation_son_g
                ContactRelation.TYPE_DAUGHTER -> com.dilib.strings.R.string.relation_daughter_g
                ContactRelation.TYPE_GRANDPARENT -> com.dilib.strings.R.string.relation_grandparent_g
                ContactRelation.TYPE_GRANDFATHER -> com.dilib.strings.R.string.relation_grandfather_g
                ContactRelation.TYPE_GRANDMOTHER -> com.dilib.strings.R.string.relation_grandmother_g
                ContactRelation.TYPE_GRANDCHILD -> com.dilib.strings.R.string.relation_grandchild_g
                ContactRelation.TYPE_GRANDSON -> com.dilib.strings.R.string.relation_grandson_g
                ContactRelation.TYPE_GRANDDAUGHTER -> com.dilib.strings.R.string.relation_granddaughter_g
                ContactRelation.TYPE_UNCLE -> com.dilib.strings.R.string.relation_uncle_g
                ContactRelation.TYPE_AUNT -> com.dilib.strings.R.string.relation_aunt_g
                ContactRelation.TYPE_NEPHEW -> com.dilib.strings.R.string.relation_nephew_g
                ContactRelation.TYPE_NIECE -> com.dilib.strings.R.string.relation_niece_g
                ContactRelation.TYPE_FATHER_IN_LAW -> com.dilib.strings.R.string.relation_father_in_law_g
                ContactRelation.TYPE_MOTHER_IN_LAW -> com.dilib.strings.R.string.relation_mother_in_law_g
                ContactRelation.TYPE_SON_IN_LAW -> com.dilib.strings.R.string.relation_son_in_law_g
                ContactRelation.TYPE_DAUGHTER_IN_LAW -> com.dilib.strings.R.string.relation_daughter_in_law_g
                ContactRelation.TYPE_BROTHER_IN_LAW -> com.dilib.strings.R.string.relation_brother_in_law_g
                ContactRelation.TYPE_SISTER_IN_LAW -> com.dilib.strings.R.string.relation_sister_in_law_g
