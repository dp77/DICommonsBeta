...
import com.dilib.commons.databinding.DialogTitleBinding
import com.dilib.commons.dialogs.*
import com.dilib.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.dilib.commons.helpers.*
import com.dilib.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.dilib.commons.helpers.MyContentProvider.MY_CONTENT_URI
import com.dilib.commons.models.*
import com.dilib.commons.views.MyTextView
import java.io.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.dilib.gallery" || applicationId == "com.dilib.gallery.debug") {
