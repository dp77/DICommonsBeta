...
object MyContentProvider {
    private const val AUTHORITY = "com.dilib.commons.provider"
    val MY_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/settings")

    const val ACTION_GLOBAL_CONFIG_UPDATED = "com.dilib.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "com.dilib.android.permission.WRITE_GLOBAL_SETTINGS"
