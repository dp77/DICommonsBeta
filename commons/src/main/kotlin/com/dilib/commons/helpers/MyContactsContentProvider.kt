...
import com.dilib.commons.extensions.getIntValue
import com.dilib.commons.extensions.getStringValue
import com.dilib.commons.models.PhoneNumber
import com.dilib.commons.models.SimpleContact
import com.dilib.commons.models.contacts.*
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.dilib.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.dilib.dialer" && packageName != "com.dilib.smsmessenger" && packageName != "com.dilib.calendar") {
                return contacts
            }
        ...
        fun getContacts(context: Context, cursor: Cursor?): ArrayList<Contact> {
            ...
            val packageName = context.packageName.removeSuffix(".debug")
            if (packageName != "com.dilib.dialer" && packageName != "com.dilib.smsmessenger" && packageName != "com.dilib.calendar"
                && packageName != "com.dilib.dialer.debug" && packageName != "com.dilib.smsmessenger.debug" && packageName != "com.dilib.calendar.debug") {
                return contacts
            }
