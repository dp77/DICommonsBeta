...
import com.dilib.commons.extensions.getInternalStoragePath
import com.dilib.commons.extensions.getSDCardPath
import com.dilib.commons.extensions.getSharedPrefs
import com.dilib.commons.extensions.sharedPreferencesCallback
...
open class BaseConfig(val context: Context) {
    ...
    var transparentNavigationBar: Boolean
        ...
        set(transparentNavigationBar) = prefs.edit().putBoolean(TRANSPARENT_NAVI_BAR, transparentNavigationBar).apply()
    ...
    var openSearch: Boolean
        ...
        set(openSearch) = prefs.edit().putBoolean(CLOSE_SEARCH, openSearch).apply()

    var closeSearch: Boolean
        get() = prefs.getBoolean(OPEN_SEARCH, false)
        set(closeSearch) = prefs.edit().putBoolean(OPEN_SEARCH, closeSearch).apply()
