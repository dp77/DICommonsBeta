...
import com.dilib.commons.compose.extensions.enableEdgeToEdgeSimple
import com.dilib.commons.compose.extensions.onEventValue
import com.dilib.commons.compose.screens.ManageBlockedNumbersScreen
import com.dilib.commons.compose.theme.AppThemeSurface
import com.dilib.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.dilib.commons.dialogs.ExportBlockedNumbersDialog
import com.dilib.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.dilib.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.dilib.dialer")) {
