...
import com.dilib.commons.databinding.ActivityCustomizationBinding
import com.dilib.commons.dialogs.*
import com.dilib.commons.extensions.*
import com.dilib.commons.helpers.*
import com.dilib.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import com.dilib.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import com.dilib.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import com.dilib.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import com.dilib.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import com.dilib.commons.helpers.MyContentProvider.COL_THEME_TYPE
import com.dilib.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import com.dilib.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import com.dilib.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import com.dilib.commons.models.GlobalConfig
import com.dilib.commons.models.MyTheme
import com.dilib.commons.models.RadioItem
import com.dilib.commons.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
        ...
        binding.customizationAppIconColorHolder.setOnClickListener {
            if (baseConfig.wasAppIconCustomizationWarningShown || !isProVersion()) {
                ...
                ConfirmationDialog(this, "", com.dilib.strings.R.string.app_icon_color_warning_g, R.string.ok, 0) {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.dilib.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
    ...
    private fun pickAppIconColor() {
        IconListDialog(
            ...
            descriptionId = com.dilib.strings.R.string.app_icon_color_warning_g
    ...
    private fun applyToAll() {
        when {
            ...
            isPro() -> {
                ...
                ConfirmationDialog(this, "", com.dilib.strings.R.string.global_theme_success_g, R.string.ok, 0) {
                    updateColorTheme(getCurrentThemeId())
                    saveChanges(false)
                }
            }
    ...
    private fun setupUseAccentColor() {
        binding.apply {
            ...
            customizationUseAccentColorFaq.setOnClickListener {
                ConfirmationDialog(this@CustomizationActivity, messageId = com.dilib.strings.R.string.use_accent_color_summary, positive = com.dilib.commons.R.string.ok, negative = 0) {}
            }
        }
    }
