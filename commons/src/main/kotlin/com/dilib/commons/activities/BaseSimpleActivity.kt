...
import com.dilib.commons.asynctasks.CopyMoveTask
...
import com.dilib.commons.interfaces.CopyMoveListener
import com.dilib.commons.models.FileDirItem
import com.dilib.commons.views.MySearchMenu
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.dilib")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.dilib.")
